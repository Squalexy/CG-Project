...
GLfloat  turquoiseAmb []={ 0.1 ,0.18725 ,0.4745 };
GLfloat  turquoiseDif []={   0.396 ,0.4 ,0.99102, 1 };
GLfloat  turquoiseSpec []={ 0.297254 ,0.30829 ,0.906678 };
...
GLint whitePlasticCoef = 1 * 128;

GLfloat  vidroAmb[] = { 0.19225 ,0.19225 ,0.19225};
GLfloat  vidroDif[] = { 0.50754 ,0.50754 ,0.50754, 0.3};
GLfloat  vidroSpec[] = { 0.508273 ,0.508273 ,0.508273};
GLint  vidroCoef = 0.4 * 128;